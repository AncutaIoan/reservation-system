...
CREATE INDEX idx_event_venue_id
    ON event(venue_id);

CREATE INDEX idx_event_starts_at
    ON event(starts_at);
...
CREATE INDEX idx_seat_venue_id
    ON seat(venue_id);
...
CREATE INDEX idx_event_seat_event_status
...
CREATE INDEX idx_reservation_event_id
...
CREATE INDEX idx_reservation_seat_event_seat
